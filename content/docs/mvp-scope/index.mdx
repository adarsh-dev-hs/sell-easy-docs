...
The MVP is delivered in the **three months** of the roadmap: [Month 1 · Foundation](/docs/roadmap/month-1-foundation), [Month 2 · Real integrations](/docs/roadmap/month-2-integrations) and [Month 3 · Harden & launch](/docs/roadmap/month-3-launch). Work starts on **5 October 2026**. Design partners go live on their own data from **16 November 2026**. The **MVP launch — which is also general availability** — is **31 December 2026**; every must-have below has to be done by then. Anything that does not fit is listed in [Beyond the MVP](/docs/roadmap/beyond-the-mvp).
</Callout>
